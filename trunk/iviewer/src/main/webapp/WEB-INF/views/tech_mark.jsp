...
<br>
<br>
<form action="tech_mark_save" method="post">
	<table width="100%">
		<tr><td><label for="prog_lang"><font size=4>Языки программирования  (0-100) </font></label></td>
			<td><input class="input-mini" id="prog_lang" type="text" name="prog_lang" value="${form.techMark.progLang}"></td>
		</tr>
		<tr><td><label for="oop"><font size=4>ООП  (0-100) </font></label></td>
			<td><input class="input-mini" id="oop" type="text" name="oop" value="${form.techMark.oop }"></td>
		</tr>
		<tr><td><label for="patterns"><font size=4>Паттерны  (0-100) </font></label></td>
			<td><input class="input-mini" id="patterns" type="text" name="patterns" value="${form.techMark.patterns }"></td>
		</tr>
		<tr><td><label for="db"><font size=4>БД  (0-100) </font></label></td>
			<td><input class="input-mini" id="db" type="text" name="db" value="${form.techMark.db }"></td>
		</tr>
		<tr><td><label for="cs"><font size=4>Компьютерные науки???  (0-100) </font></label></td>
			<td><input class="input-mini" id="cs" type="text" name="cs" value="${form.techMark.cs }"></td>
		</tr>
		<tr><td><label for="experience"><font size=4>Опыт  (0-100) </font></label></td>
			<td><input class="input-mini" id="experience" type="text" name="experience" value="${form.techMark.experience }"></td>
		</tr>
		<tr><td><label for="other"><font size=4>Другое  (0-100) </font></label></td>
			<td><input class="input-mini" id="other" type="text" name="other" value="${form.techMark.other }"></td>
		</tr>
	</table>
 	<br>
